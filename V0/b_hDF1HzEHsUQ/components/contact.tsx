  ...
  return (
    <section id="contacto" className="py-24 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 w-80 h-80 rounded-full bg-cyan-500/10 blur-3xl"
      />
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="contact-phone" className="block text-sm font-medium text-slate-700 mb-2">Telefono</label>
                      <Input
                        id="contact-phone"
                        type="tel"
