...
export function Schedule() {
  ...
  return (
    <section id="horario" className="py-24 relative overflow-hidden">
      {/* Animated Background */}
      <motion.div
        animate={{ scale: [1, 1.2, 1] }}
        transition={{ duration: 15, repeat: Infinity }}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-br from-blue-500/5 to-cyan-400/5 blur-3xl"
      />
        ...
        >
          <div className="glass-extreme rounded-3xl p-8 relative overflow-hidden">
            ...
            <motion.div
              ...
              className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-gradient-to-br from-blue-600/20 to-cyan-500/20"
            />
