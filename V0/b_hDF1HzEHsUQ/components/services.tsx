      ...
      <div className="glass-extreme rounded-3xl p-6 h-full relative overflow-hidden transition-all duration-500 group-hover:shadow-xl group-hover:shadow-blue-500/10">
        ...
        <div className="relative z-10">
          <motion.div
            ...
            className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center mb-5 shadow-lg group-hover:animate-pulse-glow`}
          >
  ...
  return (
    <section id="servicios" className="py-24 relative overflow-hidden" aria-labelledby="servicios-title">
      ...
      <motion.div
        ...
        className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-blue-500/10 to-cyan-400/10 blur-3xl -translate-y-1/2 translate-x-1/4"
      />
      <motion.div
        animate={{ scale: [1, 1.15, 1] }}
        transition={{ duration: 15, repeat: Infinity }}
        className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-gradient-to-br from-cyan-400/10 to-blue-500/10 blur-3xl translate-y-1/2 -translate-x-1/4"
      />
